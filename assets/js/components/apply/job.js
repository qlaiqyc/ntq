	...
	PageObj.page = function(){
		...
		FunUtil.common4typeMap = function(data){
			...
			execuFun.dealStatus = function(){
				switch (data.val){
					case 1: result = "待处理";				break;
					case 2: result = "内推圈简历筛选未通过";	break;
					case 3: result = "已投递至企业";			break;
					case 4: result = "企业筛选未通过";		break;
					case 5: result = "企业筛选通过";			break;
					case 6: result = "面试未通过";			break;
					default:result = "面试成功";				break;
				}
			}
			...
			form.on('submit(ntq-apply-job-condition-sbtn)', function(data) {
					...
					var Fun4Help =function(type){
						request.queryJobSeekerPositionVoList(JSON.stringify(param),function(cdata){
							...
							if(type == "init") {
								laypage({ cont: 'ntq-apply-job-condition-pag' ,pages: pages  ,jump: 
									function(obj, first){
										if(!first){
